...
document.getElementById('profile').addEventListener('submit',get_one_person_records());
            ...
            for(n in response_object){
                ...
                <div class="four">
                        <form style="background-image:url('images/paper.jpg')" >
                                    ...
                                    <h1 id = "record_date">${n['record_placement_date']}</h1><br><br>
                                    <p2 id = "body">${n['record_title']}</p2>
                                    <p2 id = "body">${n['body']}</p2>
                                    <br><br><br><br>
            
                                    <ul class='first'>
                                    <h3 id = "inside-bars">
                                        
                                        <li id="record_type">${n['record_type']}</li>
                                        <li id ="status">${n['status']}</li>
                                        <li id = "record_geolocation" >${n['record_geolocation']}</li>
                                        <li id = "record_no" >${n['record_no']}</li>
